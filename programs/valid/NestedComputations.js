...
function display(rows) {
	...
	for (var i_Patient = 0; i_Patient  < rows.length; i_Patient) {
	 ...
	 console.log(sex: rows[i_Sex].Sex, birthyear: rows[i_DateOfBirth].DateOfBirth, id: rows[i_PatientSerNum].PatientSerNum);		table.push(generatePrettyRow(Patient));
	}
	return table;
...
//Really cool timeline would go here		table.push(generatePrettyRow(Patient));
	}
	return table;
}
