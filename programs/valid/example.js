...
db.connect(function(err) {
	if (err) console.log(err);
		...
		db.query('select * from Patient where id = 1 AND id = 2 AND id > 1200 AND id < 123123 AND birthyear = 1951 AND birthyear = 1952 AND birthyear = 1953 AND birthyear = 1954 AND birthyear = 1955 AND sex = 'm'', function(err, rows, fields) {
			if (err) throw err;
		...
		db.query('select * from Doctor where id = 10001', function(err, rows, fields) {
			if (err) throw err;
			console.log(display(rows));
		});
	}
