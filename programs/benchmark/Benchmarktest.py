...
events = ["*"]
filters = "and (Patient.DateOfBirth >= 0 and Patient.DateOfBirth <= 1990) and (Patient.Sex REGEXP \"Male\") and (Patient.PatientSerNum >= 1000 and Patient.PatientSerNum <= 10000000) and (Diagnosis.Description REGEXP \"breast\" or Diagnosis.Description REGEXP \"prostate\") "
